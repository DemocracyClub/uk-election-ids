...
class TestValidator(TestCase):
    ...
    def test_invalid_ids(self):
        ...
        self.assertFalse(validate('parl.c.aberavon.2019-01-01'))  # should not have a subtype
        self.assertFalse(validate('naw.aberavon.2019-01-01'))  # should have a subtype
        self.assertFalse(validate('gla.r.barnet-and-camden.2016-05-05'))  # invalid subtype
        ...
        self.assertFalse(validate('nia.fermanagh-and-south-tyrone.something-else.2017-03-02'))
        self.assertFalse(validate('parl.aberdeen-south.something-else.2017-06-08'))
        self.assertFalse(validate('local.rugby.rokeby-and-overslade.something-else.2019-08-22'))
